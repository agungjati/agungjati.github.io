...
const routes = [
    ...
    {
        path: 'form',
        loadChildren: () => __webpack_require__.e(/*! import() | form-price-list-form-price-list-module */ "form-price-list-form-price-list-module").then(__webpack_require__.bind(null, /*! ./form-price-list/form-price-list.module */ "./src/app/demo/pages/sale/price-list/form-price-list/form-price-list.module.ts"))
            .then(module => module.FormPriceListPagePageModule)
    }
];
let PriceListPageRoutingModule = class PriceListPageRoutingModule {
};
...
let PriceListPageComponent = class PriceListPageComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
PriceListPageComponent.ctorParameters = () => [
...
let PriceListPageModule = class PriceListPageModule {
};
...
//# sourceMappingURL=price-list-price-list-module-es2015.js.map
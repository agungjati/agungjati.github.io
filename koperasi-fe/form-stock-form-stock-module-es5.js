...
var FormStockPageComponent = /** @class */ (function () {
    function FormStockPageComponent(router) {
        this.router = router;
    }
    FormStockPageComponent.prototype.ngOnInit = function () {
    };
    FormStockPageComponent.prototype.backToTable = function () {
        this.router.navigate(['/stock']);
    };
    FormStockPageComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=form-stock-form-stock-module-es5.js.map
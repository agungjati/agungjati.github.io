...
var CashierPageComponent = /** @class */ (function () {
    function CashierPageComponent() {
        var _this = this;
        this.model = '';
        ...
        this.search = function (text$) {
            ...
            var clicksWithClosedPopup$ = _this.clickProduct$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function () { return !_this.instance.isPopupOpen(); }));
        ...
        this.searchCustomer = function (text$) {
            var debouncedText$ = text$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])());
            var clicksWithClosedPopup$ = _this.clickCust$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function () { return !_this.instance.isPopupOpen(); }));
            var inputFocus$ = _this.focusCust$;
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(debouncedText$, inputFocus$, clicksWithClosedPopup$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (term) { return (term === '' ? states
                : states.filter(function (v) { return v.toLowerCase().indexOf(term.toLowerCase()) > -1; })).slice(0, 10); }));
        };
    }
    CashierPageComponent.prototype.openModal = function () {
        this.myLargeModalLabel.show(); // Show modal programmatically
    };
    CashierPageComponent.prototype.closeModal = function () {
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'history',
                loadChildren: function () { return __webpack_require__.e(/*! import() | history-sale-history-sale-module */ "history-sale-history-sale-module").then(__webpack_require__.bind(null, /*! ./history-sale/history-sale.module */ "./src/app/demo/pages/sale/history-sale/history-sale.module.ts"))
                    .then(function (module) { return module.HistorySalePageModule; }); }
            },
            {
                path: 'price-list',
                loadChildren: function () { return __webpack_require__.e(/*! import() | price-list-price-list-module */ "price-list-price-list-module").then(__webpack_require__.bind(null, /*! ./price-list/price-list.module */ "./src/app/demo/pages/sale/price-list/price-list.module.ts"))
                    .then(function (module) { return module.PriceListPageModule; }); }
            }
        ]
    },
];
...
//# sourceMappingURL=demo-pages-sale-sale-module-es5.js.map
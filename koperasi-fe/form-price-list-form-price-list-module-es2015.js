...
let FormPriceListPageRoutingModule = class FormPriceListPageRoutingModule {
};
...
let FormPriceListPageComponent = class FormPriceListPageComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
FormPriceListPageComponent.ctorParameters = () => [
...
let FormPriceListPagePageModule = class FormPriceListPagePageModule {
};
...
//# sourceMappingURL=form-price-list-form-price-list-module-es2015.js.map
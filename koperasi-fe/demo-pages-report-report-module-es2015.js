...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'expenses',
                loadChildren: () => __webpack_require__.e(/*! import() | expenses-report-expenses-report-module */ "expenses-report-expenses-report-module").then(__webpack_require__.bind(null, /*! ./expenses-report/expenses-report.module */ "./src/app/demo/pages/report/expenses-report/expenses-report.module.ts"))
                    .then(module => module.ExpensesReportPageModule)
            }
        ]
    },
];
...
let ReportPageComponent = class ReportPageComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
ReportPageComponent.ctorParameters = () => [
...
let SaleReportRoutingModule = class SaleReportRoutingModule {
};
...
let SaleReportPageComponent = class SaleReportPageComponent {
    constructor(router) {
        this.router = router;
    }
    ngOnInit() {
...
SaleReportPageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
//# sourceMappingURL=demo-pages-report-report-module-es2015.js.map
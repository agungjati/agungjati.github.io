...
var routes = [
    ...
    {
        path: 'form',
        loadChildren: function () { return __webpack_require__.e(/*! import() | form-procurement-form-procurement-module */ "form-procurement-form-procurement-module").then(__webpack_require__.bind(null, /*! ./form-procurement/form-procurement.module */ "./src/app/demo/pages/procurement/form-procurement/form-procurement.module.ts"))
            .then(function (module) { return module.FormProcurementPagePageModule; }); }
    }
];
var ProcurementPageRoutingModule = /** @class */ (function () {
    function ProcurementPageRoutingModule() {
    }
    ...
    return ProcurementPageRoutingModule;
}());
...
var ProcurementPageComponent = /** @class */ (function () {
    function ProcurementPageComponent(router) {
        this.router = router;
    }
    ProcurementPageComponent.prototype.ngOnInit = function () {
    };
    ProcurementPageComponent.prototype.gotoForm = function () {
        this.router.navigate(['/procurement/form']);
    };
    ProcurementPageComponent.ctorParameters = function () { return [
    ...
    return ProcurementPageComponent;
}());
...
var ProcurementPageModule = /** @class */ (function () {
    function ProcurementPageModule() {
    }
...
//# sourceMappingURL=demo-pages-procurement-procurement-module-es5.js.map
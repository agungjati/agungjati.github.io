...
var routes = [
    ...
    {
        path: 'form',
        loadChildren: function () { return __webpack_require__.e(/*! import() | form-member-form-member-module */ "form-member-form-member-module").then(__webpack_require__.bind(null, /*! ./form-member/form-member.module */ "./src/app/demo/pages/member/form-member/form-member.module.ts"))
...
var MemberPageRoutingModule = /** @class */ (function () {
    function MemberPageRoutingModule() {
    }
    ...
    return MemberPageRoutingModule;
}());
...
var MemberPageComponent = /** @class */ (function () {
    function MemberPageComponent(router) {
        this.router = router;
    }
    MemberPageComponent.prototype.ngOnInit = function () {
    };
    MemberPageComponent.prototype.gotoForm = function () {
        this.router.navigate(['/member/form']);
    };
    MemberPageComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=demo-pages-member-member-module-es5.js.map